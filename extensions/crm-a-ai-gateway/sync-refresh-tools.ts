 ...
 *
 *   - `crm_a_console_refresh_sync`  → cheap incremental tick (`tickPoller`).
 *   - `crm_a_console_resync_full`   → full backfill (`startBackfill`).
 *
...
const REFRESH_TOOL_NAME = "crm_a_console_refresh_sync";
const RESYNC_TOOL_NAME = "crm_a_console_resync_full";
...
/**
 * Build the `crm_a_console_refresh_sync` tool — the lightweight incremental
...
/**
 * Build the `crm_a_console_resync_full` tool — full Gmail + Calendar
