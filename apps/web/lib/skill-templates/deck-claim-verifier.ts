...
export const deckClaimVerifier = defineSkillTemplate({
  ...
  skillInstructions: [
    ...
    "Verify claims against uploaded decks/docs, HubSpot/Crm-A CRM evidence, Notion/files, native enrichment, and public primary or trusted sources depending on the selected source standard.",
