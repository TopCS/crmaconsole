...
export const investorUpdateBuilder = defineSkillTemplate({
  ...
  skillInstructions: [
    "Use files, Notion, Crm-A CRM, HubSpot, Gmail, Calendar, and manual context only as configured sources for metrics, wins, risks, asks, and prior investor commitments.",
