...
export const pipelineHygieneDigest = defineSkillTemplate({
  ...
  userUseCase: "Use this before forecast reviews or on a recurring schedule to audit Crm-A CRM and HubSpot pipeline data for stale deals, missing next steps, bad close dates, weak attribution, and owner-specific cleanup work.",
  ...
  interviewQuestions: [
    {
      ...
      freeformHint: "Name the Crm-A CRM view, HubSpot pipeline, owners, stages, or forecast period.",
    },
    {
      id: "hygiene-checks",
    ...
    },
    {
      ...
      options: [
        ...
        { id: "crm-a-summary", label: "Crm-A summary" },
  ...
  skillInstructions: [
    ...
    "Audit Crm-A CRM first and reconcile HubSpot fields when connected, preserving external record IDs and source attribution.",
