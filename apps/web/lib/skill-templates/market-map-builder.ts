...
export const marketMapBuilder = defineSkillTemplate({
  ...
  skillInstructions: [
    ...
    "Build the map from HubSpot/Crm-A CRM, native enrichment, web search, LinkedIn, and supplied files; use connected Notion, Slack, Gmail, or Calendar when they add relevant context.",
