...
export const championJobChangeTracker = defineSkillTemplate({
  ...
  skillInstructions: [
    "Identify likely champion role changes from HubSpot/Crm-A CRM contact changes, Gmail bounces or OOO replies, Crm-A-native enrichment, public profile/web evidence, and uploaded review lists; separate confirmed changes from weak hints.",
