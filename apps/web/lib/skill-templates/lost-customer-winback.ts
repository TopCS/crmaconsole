...
export const lostCustomerWinback = defineSkillTemplate({
  ...
  skillInstructions: [
    "Use Crm-A CRM churn history, closed-lost notes, enrichment, web search, files, and connected Gmail or HubSpot context to understand why each account left before recommending re-engagement.",
