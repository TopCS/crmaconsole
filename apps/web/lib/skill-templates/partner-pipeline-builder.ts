...
export const partnerPipelineBuilder = defineSkillTemplate({
  ...
  skillInstructions: [
    "Use Crm-A CRM, native enrichment, web search, and files to identify partner candidates and evidence; optionally use Gmail, Calendar, HubSpot, Notion, and Slack for prior relationship and account context.",
