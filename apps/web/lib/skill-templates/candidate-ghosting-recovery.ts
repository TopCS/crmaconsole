...
export const candidateGhostingRecovery = defineSkillTemplate({
  ...
  skillInstructions: [
    "Detect ghosting from stage-specific silence across Crm-A CRM, Gmail threads, Calendar events, Notion scorecards, and uploaded ATS exports, not one universal timer; include the last candidate touch and expected next step.",
