...
export const hiringSignalProspector = defineSkillTemplate({
  ...
  skillInstructions: [
    "Search public job postings, company career pages, LinkedIn context, Crm-A-native enrichment, HubSpot/Crm-A CRM context, uploaded lists, and Gmail history for hiring signals that match the requested roles.",
    ...
    "Exclude companies already owned by active HubSpot/Crm-A CRM opportunities or recent Gmail outreach unless the user explicitly wants them reviewed.",
