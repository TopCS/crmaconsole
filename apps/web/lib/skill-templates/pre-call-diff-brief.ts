...
export const preCallDiffBrief = defineSkillTemplate({
  ...
  skillInstructions: [
    ...
    "Use Gmail, HubSpot/Crm-A CRM, Calendar, enrichment, notes/files, and relevant public changes to lead with what changed since that last touch; skip static biography or company background unless it alters the recommended meeting plan.",
