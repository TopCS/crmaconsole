...
export const proposalChaser = defineSkillTemplate({
  ...
  interviewQuestions: [
    {
      id: "proposal-source",
      prompt: "Where should Crm-A Console find proposals to chase?",
      required: true,
      allowMultiple: true,
      options: [
    ...
    {
      id: "chase-timing",
      prompt: "When should Crm-A Console follow up after a proposal is sent?",
      required: true,
      options: [
  ...
  skillInstructions: [
    ...
    "For scheduled runs, compare against Gmail and CRM activity plus prior Crm-A notes so the same proposal is not chased twice after a reply, meeting, or owner action.",
