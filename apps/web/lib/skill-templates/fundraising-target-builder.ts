...
export const fundraisingTargetBuilder = defineSkillTemplate({
  ...
  userUseCase: "Use when a founder is preparing or maintaining a fundraise target list and wants Crm-A Console to find, enrich, rank, and track relevant investors. The skill should identify fund-stage fit, partner ownership, portfolio conflicts, warm paths, and the next action that moves each investor forward.",
  ...
  skillInstructions: [
    "Use Crm-A CRM, native enrichment, web search, and files to build investor evidence; optionally use Gmail, Calendar, HubSpot, Notion, and Slack for prior interactions, warm paths, and notes.",
