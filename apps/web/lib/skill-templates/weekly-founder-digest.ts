...
export const weeklyFounderDigest = defineSkillTemplate({
  ...
  skillInstructions: [
    "Use Crm-A CRM, enrichment, web search, files, Gmail, Calendar, and Slack to extract meetings, commitments, decisions, asks, unresolved threads, and material business changes.",
