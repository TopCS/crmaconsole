...
export const newsSignalDigest = defineSkillTemplate({
  ...
  skillInstructions: [
    "Use web search, HubSpot/Crm-A CRM records, enrichment, and files to identify relevant news; use connected Slack, Gmail, Notion, Calendar, or LinkedIn only when helpful.",
