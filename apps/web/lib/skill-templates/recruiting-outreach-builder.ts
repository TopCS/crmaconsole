...
export const recruitingOutreachBuilder = defineSkillTemplate({
  ...
  userUseCase: "Use Crm-A CRM, enrichment, web search, files, and optional LinkedIn/Gmail context to draft role-relevant recruiting outreach that feels researched without crossing privacy lines.",
