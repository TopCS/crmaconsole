...
export const companyDeepResearcher = defineSkillTemplate({
  ...
  skillInstructions: [
    "Use HubSpot/Crm-A CRM records, native enrichment, web search, LinkedIn context, Gmail history, and user-provided files as the baseline source set; use other connected apps only when they add relevant authorized context.",
  ...
  activityLogInstructions: [
    "Append research activity entries to the company dossier or Crm-A note, keyed by company, research goal, and brief version.",
