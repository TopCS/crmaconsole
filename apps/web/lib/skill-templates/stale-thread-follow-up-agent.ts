...
export const staleThreadFollowUpAgent = defineSkillTemplate({
  ...
  userUseCase:
    "Use this when important conversations have gone quiet and you need Crm-A Console to find the threads worth reviving, understand the last ask, draft a tasteful next step, and keep CRM state honest.",
  ...
  interviewQuestions: [
    {
      id: "thread-sources",
      prompt: "Where should Crm-A Console look for stale conversations?",
      required: true,
      allowMultiple: true,
      options: [
  ...
  skillInstructions: [
    ...
    "For scheduled runs, check Gmail, CRM, HubSpot, and prior Crm-A notes to avoid duplicate nudges and skip threads already handled by a teammate.",
