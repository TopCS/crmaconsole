...
export const fundingSignalProspector = defineSkillTemplate({
  ...
  skillInstructions: [
    "Search public web sources, Crm-A-native enrichment, HubSpot account context, CRM history, and uploaded/source lists for funding events that match the selected stage and freshness window.",
    "Verify funding amount, date, stage, investors, and company identity from credible sources before including a company.",
    "Filter funded companies through the requested ICP, exclusions, HubSpot/Crm-A CRM ownership, Gmail history, and duplicate checks before ranking them.",
