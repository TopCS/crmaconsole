...
export const lookalikeCustomerFinder = defineSkillTemplate({
  ...
  userUseCase: "Use this when a founder, sales team, or RevOps owner has a set of great customers and wants Crm-A Console to discover net-new accounts with similar firmographics, buying triggers, and use-case patterns. The skill should compare Crm-A CRM and HubSpot customer context, native enrichment, files, and web research to produce a defensible prospect list rather than a loose 'companies like these' dump.",
  ...
  skillInstructions: [
    "Normalize seed customers from Crm-A CRM, HubSpot, uploaded files, or user-provided text, including company domains and customer status.",
    ...
    "Search for non-customer accounts that match the selected similarity dimensions using Crm-A-native enrichment and web research.",
