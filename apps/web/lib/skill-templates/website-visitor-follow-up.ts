...
export const websiteVisitorFollowUp = defineSkillTemplate({
  ...
  userUseCase: "Turn a manual or scheduled website-visitor export into enriched account follow-up. The skill helps founders and sellers prioritize visitors by intent, match them to CRM records, research likely buyers, and create respectful follow-up actions without pretending Crm-A Console has realtime site tracking.",
  ...
  skillInstructions: [
    ...
    "Normalize visitor records by company, domain, visit date, source, page path, campaign metadata, and identity fields before matching to Crm-A CRM or HubSpot.",
    ...
    "Enrich matched companies and likely buyers with Crm-A-native enrichment, CRM history, web search, and Gmail context when connected.",
