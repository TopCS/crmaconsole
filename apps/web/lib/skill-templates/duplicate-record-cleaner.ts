...
export const duplicateRecordCleaner = defineSkillTemplate({
  ...
  userUseCase:
    "Use this when Crm-A CRM or HubSpot contains duplicate people, companies, or deals that break attribution, ownership, and reporting. The skill should identify duplicate clusters, recommend canonical records, preserve history, and only merge or update when confidence and overwrite rules are explicit.",
  ...
  interviewQuestions: [
    ...
    },
    {
      ...
      options: [
        ...
        { id: "crm-a-enrichment", label: "Crm-A enrichment" },
      ],
    },
    {
      id: "canonical-policy",
    ...
    },
    {
      ...
      allowMultiple: true,
      options: [
        { id: "crm-a-crm-note", label: "Crm-A CRM note" },
  ...
  skillInstructions: [
    ...
    "Compare Crm-A CRM records with HubSpot records when connected, keeping Crm-A attribution and external IDs intact.",
