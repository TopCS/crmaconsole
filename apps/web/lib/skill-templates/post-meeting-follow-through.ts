...
export const postMeetingFollowThrough = defineSkillTemplate({
  ...
  userUseCase:
    "Use this after meetings to turn Calendar events, Gmail threads, notes, Crm-A CRM records, HubSpot context, and Notion notes into follow-up drafts, CRM updates, tasks, and reminders. It should run manually after a selected meeting or on a cron schedule for recently completed meetings.",
  ...
  skillInstructions: [
    ...
    "Use Calendar event details to identify attendees, then gather Gmail, Crm-A CRM, HubSpot, Notion, and manual notes as available.",
