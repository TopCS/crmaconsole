...
export const icpOutreachBuilder = defineSkillTemplate({
  ...
  userUseCase: "Use when a founder or seller knows the customer profile and offer but needs Crm-A Console to turn that into a repeatable prospecting skill. The workflow should find accounts and people with Crm-A-native CRM, enrichment, and web research, draft outreach grounded in evidence, and only send when explicit rules exist.",
  ...
  interviewQuestions: [
    ...
    {
      id: "buyer-personas",
      prompt: "Which buyer personas should Crm-A Console research at each account?",
      required: true,
      allowMultiple: true,
      options: [
  ...
  skillInstructions: [
    ...
    "Use Crm-A CRM, native enrichment, Apollo-style native data, web search, HubSpot context, and Gmail history to find and prioritize accounts; never require Apollo as an external app.",
    ...
    "For scheduled runs, make each campaign idempotent by checking prior Crm-A runs, Gmail history, and CRM notes before creating new drafts or sends.",
