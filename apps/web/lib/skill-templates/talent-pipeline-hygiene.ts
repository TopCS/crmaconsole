...
export const talentPipelineHygiene = defineSkillTemplate({
  ...
  interviewQuestions: [
    {
      ...
      required: true,
      freeformHint: "Specify roles, departments, hiring stages, recruiters, date range, or saved Crm-A CRM views.",
    },
    {
      id: "hygiene-checks",
    ...
    },
    {
      ...
      required: true,
      options: [
        { id: "crm-a-tasks", label: "Crm-A tasks" },
  ...
  skillInstructions: [
    "Audit only authorized candidate and hiring records available through Crm-A CRM and connected systems.",
    ...
    "Use Gmail threads, Calendar interviews, Notion scorecards, Slack handoff context, uploaded ATS exports, and Crm-A CRM records to flag missing or stale operational fields such as owner, stage, next step, last contact, feedback, scheduled interview, or duplicate record.",
