...
export const monthEndMetricsAssembler = defineSkillTemplate({
  ...
  skillInstructions: [
    "Build a source map for every requested metric using HubSpot/Crm-A CRM, Gmail context, Notion/docs, uploaded spreadsheets, pasted numbers, and linked files; clearly separate verified values, user-provided values, stale values, and missing values.",
