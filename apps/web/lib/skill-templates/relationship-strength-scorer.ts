...
export const relationshipStrengthScorer = defineSkillTemplate({
  ...
  userUseCase: "Use this when founders, sellers, investor-relations owners, or RevOps teams need Crm-A CRM relationship strength to reflect actual recent interaction instead of stale gut feel. The skill scores named accounts, investors, partners, customers, or open opportunities from Gmail, Calendar, CRM history, and enrichment context.",
  ...
  interviewQuestions: [
    ...
    },
    {
      ...
      options: [
        ...
        { id: "crm-a-crm", label: "Crm-A CRM", description: "Native activities, tags, stage, owner, notes." },
  ...
  skillInstructions: [
    ...
    "Use Crm-A CRM as the relationship record, with Gmail, Calendar, and enrichment signals as attributed evidence sources.",
