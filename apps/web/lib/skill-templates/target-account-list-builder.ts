...
export const targetAccountListBuilder = defineSkillTemplate({
  ...
  category: "Find Leads",
  outcome: "Discovers target companies, enriches contacts, scores fit, and writes a prioritized list into Crm-A CRM.",
  userUseCase: "Use this when a founder or seller knows the market they want to attack but needs Crm-A Console to turn that ICP into a clean, ranked account list with evidence, exclusions, owners, and CRM-ready next actions.",
  ...
  skillInstructions: [
    ...
    "Use HubSpot/Crm-A CRM, native enrichment, web search, uploaded files, LinkedIn context, Gmail history, and workspace context to assemble candidate accounts.",
    "Deduplicate against existing HubSpot/Crm-A CRM accounts, customers, active opportunities, Gmail history, previous Crm-A runs, and user-provided exclusions.",
