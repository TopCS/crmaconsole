...
export const plgExpansionScout = defineSkillTemplate({
  ...
  skillInstructions: [
    ...
    "Use HubSpot/Crm-A CRM ownership, Gmail relationship history, enrichment, and account notes to explain the exact behavior that changed and why it creates a plausible expansion conversation.",
