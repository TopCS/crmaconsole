...
export const competitorMonitor = defineSkillTemplate({
  ...
  interviewQuestions: [
    ...
    },
    {
      ...
      required: true,
      options: [
        { id: "crm-a-note", label: "Crm-A note" },
  ...
  skillInstructions: [
    ...
    "Use primary sources, company sites, reputable news, HubSpot/Crm-A CRM context, enrichment, and supplied files before lower-quality commentary.",
  ...
  activityLogInstructions: [
    "Append competitor-monitor entries to the digest history, battlecard, or Slack/Crm-A destination for the monitored watchlist.",
