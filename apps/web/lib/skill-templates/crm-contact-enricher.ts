...
export const crmContactEnricher = defineSkillTemplate({
  ...
  userUseCase: "Use this when Crm-A CRM or HubSpot contacts are missing firmographic, role, company, source, owner, lifecycle, or relationship fields. The skill should run manually for a named list or on a schedule for incomplete records, enrich from Crm-A-native data first, and write only attributed, confidence-scored CRM updates.",
  ...
  interviewQuestions: [
    {
      ...
      freeformHint: "Name the Crm-A view, HubSpot list, owner, lifecycle stage, or saved segment.",
    },
    {
      id: "fields-to-enrich",
  ...
  skillInstructions: [
    ...
    "Use Crm-A CRM as the system of record, with Crm-A-native enrichment first and HubSpot, Gmail, or Calendar context only when connected and relevant.",
