...
const customerValidatedInstructions = [
  "Treat Crm-A CRM, connected Gmail, connected HubSpot, uploaded files/manual exports, web research, and Crm-A-native enrichment as available source primitives; only mark a capability unavailable when the specific user data or permission is missing.",
