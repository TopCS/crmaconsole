...
export const warmLeadNurture = defineSkillTemplate({
  ...
  userUseCase:
    "Use this when leads are interested but not ready to buy, meet, invest, partner, or hire yet, and you want Crm-A Console to keep them warm with useful, low-pressure touches. The skill should segment leads, find timely reasons to reach out, and maintain nurture state from manual runs or scheduled checks without relying on webhooks.",
  ...
  interviewQuestions: [
    ...
    {
      id: "touchpoint-types",
      prompt: "What kinds of nurture touches should Crm-A Console use?",
      required: true,
      allowMultiple: true,
      options: [
  ...
  skillInstructions: [
    "Build the nurture queue from Crm-A CRM, enriched company/contact data, uploaded files, or connected HubSpot lists, then segment leads by persona, account fit, reason for delay, and last meaningful interaction.",
