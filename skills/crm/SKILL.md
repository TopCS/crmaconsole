...
| **CDP**               | `crm/cdp/SKILL.md`               | Journey events (web tracker + `/api/crm/events` ingestion), anonymous identity resolution (shadow people + merge), segments (demographic + event filters), email campaigns to segments                                                                                                                |
